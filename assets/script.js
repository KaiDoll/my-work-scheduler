...
console.log(currentHour) //checking to see if the time works. 
...
// var saveBttn = document.getElementsByClassName("saveBtn");

// saveBttn.addEventListener('click', getInfo)

// $(".saveBtn").click(function () {
function getInfo () {
  // var textBox = document.getElementsByClassName('description')
  localStorage.setItem('Schedule', document.getElementsByClassName ('description')); 
...
//   if(saveText) { 
//     document.getElementById('description').value = saveText; 
